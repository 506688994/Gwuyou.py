...
class LogIn(object):
    ...
    def Login_Ui(self, form):
        form.setFixedSize(350, 200)  # 设置窗口大小
        self.main_widget.setLayout(self.main_layout)  # 设置窗口部件为网格布局
        #form.setCentralWidget(self.main_widget)  # 设置窗口中心
        ...
        #form.setAttribute(QtCore.Qt.WA_TranslucentBackground)  # 设置窗口背景透明
        #form.setWindowOpacity(0.9)  # 设置窗口透明度
        #form.setWindowFlag(QtCore.Qt.FramelessWindowHint)  # 隐藏边框去除窗口边框
        ...
        # 左侧按钮美化-----------------------------------------------------------------------------------
        self.main_widget.setStyleSheet("QWidget#main_widget{border-radius:100px;}")
"""
